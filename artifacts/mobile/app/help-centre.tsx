...
const HELP_SECTIONS: HelpSection[] = [
  { id: "faq", title: "FAQs", icon: HelpCircle, color: "#C4662A", faqs: [
    ...
    { question: "How do I join a prayer group?", answer: "Tap the 'Prayer Groups' tab and look for the 'Join Prayer Group' option. You'll be asked to enter an invite code provided by the group admin." },
